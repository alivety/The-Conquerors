...
public class ErrorDialog extends JFrame {
	...
	public ErrorDialog(String errorLabelText, String errorDescription,
			Throwable e) {
	...
	public ErrorDialog(String errorLabelText, Throwable e) {
		...
		viewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (open) {
					...
					ErrorDialog.this.setSize(dialogWidth, dialogHeight);
					...
					ErrorDialog.this.setSize(dialogWidth,
							dialogHeight + 100);
